...
/**
 * @file plugins/themes/default/JABSThemePlugin.inc.php
 *
...
class JabsThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.jabs.option.typography.label'),
			'description' => __('plugins.themes.jabs.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.jabs.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.jabs.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.jabs.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.jabs.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.jabs.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.jabs.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.jabs.option.typography.lora_openSans'),
				],
			],
			'default' => 'notoSans',
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.jabs.option.colour.label'),
			'description' => __('plugins.themes.jabs.option.colour.description'),
			'default' => '#1E6292',
		]);
		...
		$this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
			'label' => __('manager.setup.contextSummary'),
				...
				[
					'value' => true,
					'label' => __('plugins.themes.jabs.option.showDescriptionInJournalIndex.option'),
				],
			],
			'default' => false,
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.jabs.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.jabs.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.jabs.option.useHomepageImageAsHeader.option')
				],
			],
			'default' => false,
		]);
		...
		$this->addScript('jabs', 'js/main.js');
	...
	function getDisplayName() {
		return __('plugins.themes.jabs.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.jabs.description');
	}
}
